...
{
$msg="<select id='selected_function' ondblclick='selected_fuction(this);' class='form-control' style=' position:absolute; width:91%; margin-top:-16px; z-index:1000;' size='5' >";
